...
//   expect(() => new BSTBuilder().add('string', 0).add('string', 1)).toThrow();
// });
...
//   expect(() => new BSTBuilder().build()).toThrow();
// });
